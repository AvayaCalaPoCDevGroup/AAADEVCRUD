...
document.getElementById('submitbtn').addEventListener('click', function (e) {
    ...
    if (document.getElementById('country').value === "" || document.getElementById('country').value.length === 0) {
        ...
        data.append("Email", CryptoJS.AES.encrypt(document.getElementById('email').value, "AAADEVAvayaCRUD"));
        data.append("Pass", CryptoJS.AES.encrypt(document.getElementById('pass').value, "AAADEVAvayaCRUD"));
        data.append("Cliente", CryptoJS.AES.encrypt(document.getElementById('cliente').value, "AAADEVAvayaCRUD"));
        data.append("Pais", CryptoJS.AES.encrypt(document.getElementById('country').value, "AAADEVAvayaCRUD"));
