...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" src="LogIn/js/aes.js"></script>
        <script type="text/javascript" src="LogIn/js/sweetAlertmin.js"></script>
